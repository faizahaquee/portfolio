...
export default function GraphicDesignSection() {
  ...
  const images = [
    { src: '/graphic-designs/akira offline 2.png', className: 'w-40 md:w-56 top-[5%] left-[5%] rotate-[-5deg]' },
    { src: '/graphic-designs/akira offline.png', className: 'w-48 md:w-64 top-1/2 right-[5%] rotate-[3deg]' },
    { src: '/graphic-designs/CLUB AKIRA LOGO-02.png', className: 'w-36 md:w-48 bottom-[15%] left-[2%] rotate-[5deg]' },
    { src: '/graphic-designs/OPEN LETTER.png', className: 'w-56 md:w-72 bottom-[5%] right-[20%] rotate-[-2deg]' },
    { src: '/graphic-designs/rose bday poster 2.png', className: 'w-32 md:w-48 top-[10%] right-[30%] rotate-[4deg]' },
    { src: '/graphic-designs/rose bday poster.png', className: 'w-40 md:w-52 bottom-[20%] left-[40%] rotate-[-3deg]' },
    { src: '/graphic-designs/SUMMER SEND OFF.png', className: 'w-44 md:w-56 top-[20%] left-[30%] rotate-[2deg]' },
    { src: '/graphic-designs/TANG CYPHER.png', className: 'w-36 md:w-48 bottom-[35%] right-[35%] -rotate-[5deg]' }
  ];
